...
namespace TaskFlow.Detection
{
    ...
    {
        public override bool Result() => !SubDetections.IsEmpty && SubDetections.All(subDetection => subDetection.Result());
    }

    /// 组合判定：或运算
    public class Or : CombinationDetection
    {
        public override bool Result() => !SubDetections.IsEmpty && SubDetections.Any(subDetection => subDetection.Result());
    }
